 <body style="background-color:#F5F5DC">
 		...
 		<div id="text">
	 		<b> Who do we want on our team?</b>
	 			<p>
					...
					The internship is open to all undergraduates.
				</p>
					 

			<b>Contact mpowered-kenya@umich.edu if you have any questions. </b><br>

			<br>
			<b> What will you be doing?</b>
				<p>
			<br>The Kenya Team will participate in a crash course for social entrepreneurship organized by MPowered along with cultural exposure to Swahili and what life is like in Kenya throughout the winter semester.
	...
	<p> <br> Pictures from last year's trip. </p>
	...
	<br><b>Commonly Asked Questions:</b><br>
	
	<br><b> What if I'm not passionate about business?</b>
		<p>
			<br>We use the term business very broadly.  This does not mean you need business interest or knowledge.  In fact, the most productive teams have people from all different backgrounds like business, engineering, art & design, etc.  By business, we mean your goal is to generate a sustainable model for creating economic value in a for-profit or not-for-profit way.  The primary goal is to create social value in job creation or standard of living.  You are encouraged to follow your passions and work on a project to make it sustainable.  For example, if you are passionate about water quality, your "business" can center on that.
		</p>
	<br><b>Do I work on my own idea or do we have one idea as a team?</b>
		<p>
		<br> When you arrive in Kenya, you'll be grouped with Kenyan locals who know the economy, environment, and have ideas of their own.  The project is a collaboration between us and them.  They will bring invaluable knowledge to the discussion.  There is no requirement for how many people you can work with.  You can work on your idea with Kenyans, you can work with another UM student and Kenyans, or all 7 UM students can work together with Kenyans on one idea.  What tends to happen is people have different interests and passions, so teams will split along those lines and you can focus on an idea you care about.
		</p>
	<br><b>What ideas did last year's team come up with?</b>
		<p>
		<br> Last year, we had six business plans produced from the 5 UM students who went and their partnership with Kenyan locals.  They were focused on eco-tourism, online Swahili tutoring, agriculture, an after-school program for youth, creation of soap for sanitation, and a job recruitment agency for high school graduates.  
		</p>
	<br><b>Will I really be able to start an actual business?</b>
		<p>
		<br> It's all about internal motivation and what you put into it.  Realistically, we can't promise that you'll find that amazing idea and become really successful with it.  It's important to recognize that what we are trying to do is difficult and the success rate is low.  What we can promise is an experience you'll never forget, a chance to apply knowledge and experience entrepreneurship unlike any other, and the reality of seeing your work change lives.  For the continuation of the business, it's up to how much time you invest in it.  If you decide to pursue it, we will be behind you 100%.  MPowered is here to provide as much support and resources as possible, but we recognize that you are a student and have those obligations as well.
		</p>
	</div>
</div>
</body>